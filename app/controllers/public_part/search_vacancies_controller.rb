module PublicPart
  class SearchVacanciesController < BaseController
    def index
    ...
    def search_params
      params.permit(:company_id, :country, :city, :continent)
    end
    ...
    def vacancies
      ...
      buf_vacancies = buf_vacancies.search_by(:continent, search_params[:continent]) if search_params[:continent].present?
